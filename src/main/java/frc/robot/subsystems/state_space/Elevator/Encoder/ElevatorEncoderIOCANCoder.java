...
public class ElevatorEncoderIOCANCoder extends EncoderIOCANCoder implements ElevatorEncoderIO {
    public ElevatorEncoderIOCANCoder(int canID, CANBus canBus, String name, double conversionFactor,
    ...
    public ElevatorEncoderIOCANCoder(int canID, CANBus canBus, String name) {
        this(canID, canBus, name, 1.0, 0, false);
    }

    public ElevatorEncoderIOCANCoder(int canID, String name, double conversionFactor, double encoderOffsetRotations,
            boolean isInverted) {
    ...
    public ElevatorEncoderIOCANCoder(int canID, String name, double conversionFactor) {
        this(canID, name, conversionFactor, 0, false);
    }

    public ElevatorEncoderIOCANCoder(int canID, String name) {
